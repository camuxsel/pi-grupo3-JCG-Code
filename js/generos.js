...
.then(function (data) {
    ...
    for (let i = 0; i < generos.length; i++) {
        ...
        contenido_generos_peliculas += `<li class="lista-generos"> <a href="./genero.html?idGeneros= ${genero["id"]}">${genero["name"]}</a> </li>`  
    };
...
.then(function (data) {
    ...
    for (let i = 0; i < generos.length; i++) {
        let genero = generos[i];
        contenido_generos_series += `<li class="lista-generos"> <a href="./genero.html?idGeneros= ${genero["id"]}">${genero["name"]}</a> </li>`  
    };
